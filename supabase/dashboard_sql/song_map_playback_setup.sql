-- Adds the map read RPC and server-only song access RPC for location-gated playback.
-- Paste this into the Supabase Dashboard SQL Editor and run it before deploying
-- the song-access Edge Function.
